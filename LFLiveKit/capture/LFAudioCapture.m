...
- (void)setRunning:(BOOL)running {
    ...
    if (_running) {
        dispatch_async(self.taskQueue, ^{
            ...
            [[AVAudioSession sharedInstance] setCategory:AVAudioSessionCategoryRecord withOptions:AVAudioSessionCategoryOptionDefaultToSpeaker | AVAudioSessionCategoryOptionInterruptSpokenAudioAndMixWithOthers error:nil];
